...
const EN_TRANSLATIONS: TranslationMap = {
  ...
  'streams.badge_debrid_http': '⚡ Debrid Stream',
  'streams.badge_p2p_magnet': '🧲 P2P Magnet',
  'streams.audio_notice': '💡 Audio Tip: Some Debrid/Stremio MKVs with AC3/EAC3/DTS audio lack browser HTML5 codecs. For surround sound, use External Player (PotPlayer/VLC/MPV/Infuse).',
